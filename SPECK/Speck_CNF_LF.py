...
def diff_Add_CNF(self,a, b, c, w, wordsize):
    ...
    for i in range(wordsize - 1):
        command += "ASSERT((({0}[{3}:{3}]) | ({1}[{3}:{3}]) | (~{2}[{3}:{3}]) | ({0}[{4}:{4}]) | ({1}[{4}:{4}]) | ({2}[{4}:{4}])) = 0bin1);\n".format(a, b, c, i+1, i)
        command += "ASSERT((({0}[{3}:{3}]) | (~{1}[{3}:{3}]) | ({2}[{3}:{3}]) | ({0}[{4}:{4}]) | ({1}[{4}:{4}]) | ({2}[{4}:{4}])) = 0bin1);\n".format(a, b, c, i+1, i)
        command += "ASSERT(((~{0}[{3}:{3}]) | ({1}[{3}:{3}]) | ({2}[{3}:{3}]) | ({0}[{4}:{4}]) | ({1}[{4}:{4}]) | ({2}[{4}:{4}])) = 0bin1);\n".format(a, b, c, i+1, i)
        command += "ASSERT(((~{0}[{3}:{3}]) | (~{1}[{3}:{3}]) | (~{2}[{3}:{3}]) | ({0}[{4}:{4}]) | ({1}[{4}:{4}]) | ({2}[{4}:{4}])) = 0bin1);\n".format(a, b, c, i+1, i)
        command += "ASSERT((({0}[{3}:{3}]) | ({1}[{3}:{3}]) | ({2}[{3}:{3}]) | (~{0}[{4}:{4}]) | (~{1}[{4}:{4}]) | (~{2}[{4}:{4}])) = 0bin1);\n".format(a, b, c, i+1, i)
        ...
        command += "ASSERT(((~{0}[{3}:{3}]) | ({1}[{3}:{3}]) | (~{2}[{3}:{3}]) | (~{0}[{4}:{4}]) | (~{1}[{4}:{4}]) | (~{2}[{4}:{4}])) = 0bin1);\n".format(a, b, c, i+1, i)
        command += "ASSERT(((~{0}[{3}:{3}]) | (~{1}[{3}:{3}]) | ({2}[{3}:{3}]) | (~{0}[{4}:{4}]) | (~{1}[{4}:{4}]) | (~{2}[{4}:{4}])) = 0bin1);\n".format(a, b, c, i+1, i)
        command += "ASSERT(((~{0}[{5}:{5}]) | ({2}[{5}:{5}]) | ({3}[{4}:{4}])) = 0bin1);\n".format(a, b, c, w, i, i)
        command += "ASSERT((({1}[{5}:{5}]) | (~{2}[{5}:{5}]) | ({3}[{4}:{4}])) = 0bin1);\n".format(a, b, c, w, i, i)
        command += "ASSERT((({0}[{5}:{5}]) | (~{1}[{5}:{5}]) | ({3}[{4}:{4}])) = 0bin1);\n".format(a, b, c, w, i, i)
        command += "ASSERT((({0}[{5}:{5}]) | ({1}[{5}:{5}]) | ({2}[{5}:{5}]) | (~{3}[{4}:{4}])) = 0bin1);\n".format(a, b, c, w, i, i)
        command += "ASSERT(((~{0}[{5}:{5}]) | (~{1}[{5}:{5}]) | (~{2}[{5}:{5}]) | (~{3}[{4}:{4}])) = 0bin1);\n".format(a, b, c, w, i, i)
    return command
 
def diff_Xor_CNF(self,a, b, c, wordsize):
...
class Diff_Speck_CNF_LF_Cipher:
    ...
    def setupSpeckRound(self, stp_file, x_in, y_in, x_out, y_out, w, wordsize):
        ...
        command += diff_Add_CNF(self,rotr(x_in, self.rot_alpha, wordsize), y_in, x_out, w,wordsize)

        command += diff_Xor_CNF(self,rotl(y_in, self.rot_beta, wordsize),x_out,y_out, wordsize)
...
def main():
    ...
    checkenviroment()
    cipher_suite = Diff_Speck_CNF_LF_Cipher()
